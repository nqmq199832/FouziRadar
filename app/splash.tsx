  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.logoContainer, logoStyle]}>
        <Image 
          source={{ uri: 'https://images.pexels.com/photos/5589955/pexels-photo-5589955.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2' }} 
          style={styles.logo}
          resizeMode="cover"
        />
        <Text style={styles.appName}>FouziRadar DZ</Text>
      </Animated.View>
